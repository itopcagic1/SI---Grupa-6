...
function Login() {
  ...
  const onSubmit = (data) => {
    console.log("Podaci za prijavu:", data);
    // ovdje dodati api poziv kasnije
  };
        ...
        <div className="bg-white/90 backdrop-blur-xl py-10 px-8 shadow-2xl rounded-[40px] border border-white/50">
          ...
          <div className="mt-8 text-center border-t border-amber-50 pt-6">
            <p className="text-sm text-slate-400 font-medium">
              Nemaš nalog? <Link to="/register" className="text-orange-600 font-black hover:underline ml-1 uppercase text-xs tracking-tighter">Registruj se</Link>
            </p>
          </div>
        </div>
      </div>
