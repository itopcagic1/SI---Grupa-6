        ...
        {isAuthenticated ? (
          <>
            <div className="w-8 h-8 rounded-full bg-orange-200 flex items-center justify-center text-orange-800 font-bold text-sm">
              {korisnik
                ? (
                    korisnik.punoIme?.charAt(0) ||
                    korisnik.email?.charAt(0) ||
                    '?'
                  ).toUpperCase()
                : '?'}
            </div>
          ...
          <>
            <Link
              to="/login"
              className="px-4 py-2 text-slate-600 font-bold hover:text-orange-600 transition-colors text-sm uppercase tracking-widest"
            >
              Login
            </Link>
            ...
            <Link
              to="/register"
              className="px-5 py-2.5 bg-orange-600 text-white rounded-xl font-bold hover:bg-orange-700 transition-all text-sm uppercase tracking-widest shadow-md shadow-orange-600/20 active:scale-95"
            >
              Registracija
            </Link>
          </>
