...
- **Kritika:** Uočena je kardinalna greška u poslovnoj logici sistema koja dozvoljava da **broj asistencija bude veći od ukupnog broja golova**. U sportskom kontekstu, broj asistencija ne može matematički nadmašiti broj postignutih pogodaka, te ova anomalija narušava validnost i konzistentnost statističkih podataka u bazi.
...
1. **Backend validacija poslovne logike:**
   - Implementirati restrikciju na nivou kontrolera/DTO-a (Data Transfer Object) prilikom unosa i ažuriranja statistike meča koja automatski odbija zahtjev ukoliko je `broj_asistencija > broj_golova`.
