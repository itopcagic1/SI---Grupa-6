...
## 4. USER STORY – Vlasnik objekta (upravljanje terminima)
...
- Korisnik treba dobiti obavještenje o promjeni statusa termina
 ...
 ### 4.1 USER STORY – Pregled kalendara termina
...
### 4.2 USER STORY – Kreiranje slobodnog termina
...
### 4.3 USER STORY – Blokiranje termina
...
### 5. USER STORY – Vlasnik objekta (odobravanje rezervacija)
...
### 5.1 USER STORY – Pregled zahtjeva
...
### 5.2 USER STORY – Odobravanje rezervacije
...
### 5.3 USER STORY – Odbijanje rezervacije
...
### 6. USER STORY – Navijač (pregled sadržaja)
...
**Opis:**
Kao posjetilac stranice želim da imam uvid u rezultate i tabele uz mogućnost filtriranja, dok kao registrovani korisnik želim dodatnu opciju praćenja omiljenog tima.
...
### 6.1 USER STORY – Pregled bez registracije
...
### 6.2 USER STORY – Filtriranje sadržaja
...
### 6.3 USER STORY – Registracija navijača
...
### 7. USER STORY – Administrator (upravljanje korisnicima)
...
**Opis:**
Kao administrator, želim da upravljam korisnicima, kako bih osigurao rad i sigurnost sistema.
...
### 7.1 USER STORY – Pregled korisnika
...
### 8. USER STORY – Administrator (upravljanje sadržajem)
...
### 8.1 USER STORY – Upravljanje sportovima
...
### 8.2 USER STORY – Upravljanje ligama i sadržajem
...
### 8.3 USER STORY – Administracija baze i sistema
